    ...
    on<HomeBaseSecStartFlow>((event, emit) async {
      ...
      switch (flowText) {
        case AppStrings.inventory:
          if (SessionManager().isCashier) {
            AppUtil.toastMessage(
              message: 'Sorry, Your Not Approve For This Feature.',
        ...
        case AppStrings.sales:
          AppNavigator.gotoSales(context: sectionContext, data: event.item);
          break;
        ...
        case AppStrings.reports:
          if (SessionManager().isCashier) {
            ...
            AppNavigator.gotoReports(context: sectionContext, data: event.item);
          }

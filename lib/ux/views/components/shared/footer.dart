            ...
            children: [
              TextButton.icon(
                ...
                icon:RepaintBoundary(
                  child: SvgPicture.asset(AppDrawables.phoneSVG,height: 10, color: Colors.white,)),
                label: Text(
...
class setUpSupportInfo extends StatelessWidget {
  const setUpSupportInfo({super.key});

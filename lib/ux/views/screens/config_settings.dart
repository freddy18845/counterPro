...
import "../../models/shared/notification_settings.dart";
             ...
             SizedBox(
               ...
               child: Row(
                 ...
                 children: [
                   const Text(
                     "Enable Popup Alerts",
                     style: TextStyle(fontSize: 13), // Adjusted for the 30px height
                   ),
                   const SizedBox(width: 8),
                   Transform.scale(
                     scale: 0.8, // Slightly scale down to fit comfortably in 30px height
                     child:Switch(
                       activeColor: AppColors.secondaryColor,
                       value: StockMonitorService.enablePopupAlerts,
                       onChanged: (value) async {
                         // 1. Update the actual data/service
                         await StockMonitorService.setEnablePopupAlerts(value);

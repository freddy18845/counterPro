...
//
//     final outletQueryRequest = outletQueryRequestFromJson(jsonString);

import 'dart:convert';

OutletQueryRequest outletQueryRequestFromJson(String str) => OutletQueryRequest.fromJson(json.decode(str));

String outletQueryRequestToJson(OutletQueryRequest data) => json.encode(data.toJson());

class OutletQueryRequest {
  Header? header;
  String? messageType;
  String? dateTime;
  ...
  factory OutletQueryRequest.fromJson(Map<String, dynamic> json) => OutletQueryRequest(

class PasswordChangeResponse {
  final PasswordChangeResponseHeader header;
  ...
  factory PasswordChangeResponse.fromJson(Map<String, dynamic> json) {
    return PasswordChangeResponse(
      header: PasswordChangeResponseHeader.fromJson(json['Header']),
...
class PasswordChangeResponseHeader {
  ...
  factory PasswordChangeResponseHeader.fromJson(Map<String, dynamic> json) {
    return PasswordChangeResponseHeader(

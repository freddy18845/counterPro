...
Future<void> precacheAppImages(BuildContext context) async {
  ...
  final svgImages = [
    ...
    AppDrawables.withdrawalSVG,
    AppDrawables.walletSVG,
    AppDrawables.transfersSVG,
    AppDrawables.depositSVG,
    AppDrawables.transactionSVG,
    AppDrawables.mobileWalletSVG,
    AppDrawables.accountPaySVG,
    AppDrawables.p2pPaySVG,
    AppDrawables.cardSVG,
    AppDrawables.transactionSVG,
    AppDrawables.chequeSVG,
